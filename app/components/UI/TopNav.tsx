...
export default function TopNav({ activeSection }: TopNavProps) {
    ...
    return (
        <nav
            className={`fixed top-0 left-0 w-full z-50 flex justify-center py-6 transition-all duration-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-full pointer-events-none"
                }`}
        >
