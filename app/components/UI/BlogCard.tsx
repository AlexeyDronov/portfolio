...
export default function BlogCard({ title, description, date, slug }: BlogCardProps) {
    return (
        <div className="group flex flex-col gap-2 p-6 rounded-2xl bg-white/5 border border-white/10 transition-all duration-300 hover:bg-white/10 hover:border-white/20 hover:-translate-x-1">
