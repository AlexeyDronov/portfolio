    ...
    return (
        <div className="flex flex-col w-full">
            <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-8 w-full border-b border-white/10 pb-8">
                ...
                <button
                    onClick={toggleSort}
                    className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all text-sm font-medium text-white/80 whitespace-nowrap cursor-pointer"
                >
                    <ArrowDownUp size={16} />
